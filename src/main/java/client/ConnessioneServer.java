...
public class ConnessioneServer {
    ...
    /**
     * Costruttore privato del singleton. Non è possibile istanziare questa classe direttamente.
     ...
     * @return True se la connessione è stabilita con successo, altrimenti false.
     */
    ...
    /**
     * Invia una richiesta al server per verificare se l'userID specificato è disponibile per la registrazione.
     * @param username L'userID da verificare.
     * @return True se l'userID è disponibile, altrimenti false.
     * @throws RemoteException Se si verifica un errore durante la comunicazione con il server.
     */
     ...
     * @return True se l'inserimento della canzone è avvenuto con successo, false altrimenti.
     * @throws RemoteException Se si verifica un errore durante la comunicazione con il server.
     */
    ...
    /**
     * Invia una richiesta al server per verificare se è possibile rimuovere i punteggi delle emozioni
     * assegnate dall'utente alla canzone corrente.
     * @return True se è possibile rimuovere i punteggi delle emozioni, altrimenti false.
     * @throws RemoteException Se si verifica un errore durante la comunicazione con il server.
     */
