...
public class ListaEmozioniController implements Initializable {
    ...
    /**
     * Pulsante per salvare i punteggi delle emozioni ed eventuali commenti della rispettiva canzone.
    ...
    /**
     * Pulsante che resetta i punteggi ed eventuali commenti inseriti nella tabella.
    ...
    /**
     * Torna alla scena {@link ListaCanzoniController} dopo aver premuto sul pulsante "<--".
