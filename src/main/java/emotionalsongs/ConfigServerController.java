...
public class ConfigServerController implements Initializable {
     ...
     * @return True se l'indirizzo IP è valido, altrimenti false.
     */
     ...
     * @return True se la porta è valida, altrimenti false.
     */
    ...
    /**
     * Ritorna alla scena principale {@link LoginController} quando l'utente preme il pulsante "Annulla".
     * @param actionEvent L'evento generato dal click sul pulsante.
