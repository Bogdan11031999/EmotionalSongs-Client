...
public class StatsEmozioneBranoController implements Initializable {
     ...
     * Il TextArea è disabilitato in modo che non si possa scrivere.
     */
    @FXML
    ...
    /**
     * Variabile booleana per indicare se il timer è in esecuzione.
     */
    private boolean isTimerRunning = false;
    /**
     * Variabile booleana per indicare se la riproduzione della canzone è completata.
     */
     ...
     * in tempo reale. Quando la canzone è completata, il timer viene fermato.
    ...
    /**
     * Verifica se l'utente è loggato e se è presente una playlist corrente.
     * Se entrambe le condizioni sono verificate, visualizza la scena {@link ListaCanzoniController}
     * Se invece la playlist corrente è nulla, viene visualizzata la scena {@link ConsultaCanzoniController}.
