...
public class RegistrazioneController implements Initializable{
     ...
     * per eseguire operazioni riguardanti la registrazione utente e altre funzionalità.
     */
    @Override
    ...
    /**
     * Verifica la validità dei dati inseriti nel form di registrazione.
    ...
    /**
     * Verifica se l'userID è disponibile e formatto correttamente.
     * @param user L'userID del nuovo utente
     * @return True se l'userID è disponibile e
    ...
    /**
     * Verifica se il codice fiscale è formattato correttamente e ha il numero di caratteri necessari.
    ...
    /**
     * Verifica se il campo dato è nel formato corretto (non nullo e con almeno un carattere).
     ...
     * @return L'array di boolean che indica per ogni campo se è corretto o meno.
     * @throws RemoteException Se si verifica un errore durante la comunicazione con il server
     */
    ...
    /**
     * Ritorna alla scena principale {@link LoginController}.
