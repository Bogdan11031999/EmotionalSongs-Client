...
public class ConsultaCanzoniController implements Initializable {
     ...
     * Questa colonna è invisibile agli utenti, ma utilizzata internamente per il recupero dei dati.
     */
    @FXML
    ...
    /**
     * Verifica se è necessario aggiornare l'elenco delle canzoni in base al timestamp di ultima modifica.
     * @param connectServer L'istanza della connessione al server remoto.
     * @param songManager L'istanza del gestore delle canzoni.
     * @return True se è necessario aggiornare l'elenco delle canzoni, altrimenti false.
     */
     ...
     * Quando viene selezionata una canzone, viene caricata la scena {@link StatsEmozioneBranoController}.
    ...
    /**
     * Ritorna alla scena principale {@link LoginController} se l'utente non è loggato,
     * altrimenti alla rispettiva libreria playlist.
