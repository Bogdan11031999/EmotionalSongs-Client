...
public class MainController extends Application {
     ...
     * Lo stage è responsabile per il contenimento e la visualizzazione delle diverse scene.
     */
    ...
    /**
     * Carica la scena {@link ConfigServerController} e la imposta come scena attuale.
    ...
    /**
     * Carica la scena {@link LoginController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link RegistrazioneController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link ListaPlaylistController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link ConsultaCanzoniController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link NomePlaylistController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link NomeCanzoneController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link ListaCanzoniController} e la imposta come scena attuale.
     * @throws IOException  Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link  ListaEmozioniController} e la imposta come scena attuale.
     * @throws IOException Se si verifica un errore durante il caricamento della scena.
     */
    ...
    /**
     * Carica la scena {@link StatsEmozioneBranoController} e la imposta come scena attuale.
